...
class Basecalender(_PrismaModel):
    __prisma_model__: ClassVar[Literal['calender']] = 'calender'

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.calenderActions[_PrismaModelT]':
        from .client import get_client

        return actions.calenderActions[_PrismaModelT](client or get_client(), cls)
