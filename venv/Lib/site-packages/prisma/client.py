...
SCHEMA_PATH = Path('C:/Users/Francine-MariaAwezig/PythonProjects/Google-Calender-Integration/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\Francine-MariaAwezig\\.cache\\prisma-python\\binaries\\4.15.0\\8fbc245156db7124f997f4cecdd8d1219e360944\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    calender: 'actions.calenderActions[models.calender]'
    ...
    def __init__(
        ...
        *,
        ...
        self.calender = actions.calenderActions[models.calender](self, models.calender)
...
class Batch:
    calender: 'calenderBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.calender = calenderBatchActions(self)
...
class calenderBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.calenderCreateInput,
        include: Optional[types.calenderInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
    ...
    def create_many(
        self,
        data: List[types.calenderCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.calenderWhereUniqueInput,
        include: Optional[types.calenderInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.calenderUpdateInput,
        where: types.calenderWhereUniqueInput,
        include: Optional[types.calenderInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.calenderWhereUniqueInput,
        data: types.calenderUpsertInput,
        include: Optional[types.calenderInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.calenderUpdateManyMutationInput,
        where: types.calenderWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.calender,
    ...
    def delete_many(
        self,
        where: Optional[types.calenderWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.calender,
